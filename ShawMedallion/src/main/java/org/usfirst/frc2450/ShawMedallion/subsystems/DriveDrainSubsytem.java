...
public class DriveDrainSubsytem extends Subsystem {
    ...
    public double getLeftStrafeRate() {
        if (LimelightSubsystem.getTs() < Robot.limelightSubsystem.minSkew) {
            double speed = LimelightSubsystem.getTs() / 90d;
            if (speed < -Robot.limelightSubsystem.alignSpeed) {
                return Robot.limelightSubsystem.alignSpeed;
            }
            return -speed;
        }
        return -0;
