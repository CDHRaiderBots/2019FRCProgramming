 ...
 *
 */
public class RightPanelPlaceHigh extends CommandGroup {


    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
    public RightPanelPlaceHigh() {
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=PARAMETERS
        ...
        addSequential(new TargetAlignRight());
        addSequential(new ApproachTarget());
        addSequential(new ElevatorHigh());
        addSequential(new ActivatePanelPiston());
        addSequential(new DeactivatePanelPiston());
