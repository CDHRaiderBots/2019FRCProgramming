...
public class ClimbSubsystem extends Subsystem {
    ...
    public ClimbSubsystem() {
        ...
        climbMotor = new Encoder(5, 6, false, EncodingType.k4X);
        addChild("Quadrature Encoder 1",climbMotor);
        climbMotor.setDistancePerPulse(1.0);
        climbMotor.setPIDSourceType(PIDSourceType.kRate);
        ...
        pistonWheelMotorSpx = new WPI_VictorSPX(0);
        compressor.setClosedLoopControl(true);
        // climbMotor.setDistancePerPulse( / 102400);
    }
