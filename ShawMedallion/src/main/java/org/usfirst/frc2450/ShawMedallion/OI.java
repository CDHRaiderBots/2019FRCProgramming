...
public class OI {
    ...
    public OI() {
        ...
        elevatorDropButton = new JoystickButton(joystick, 2);
        ...
        pistonDownButton = new JoystickButton(joystick, 32);
        pistonDownButton.whileHeld(new PistonDown());
        pistonUpButton = new JoystickButton(joystick, 32);
        ...
        SmartDashboard.putData("TargetAlign", new TargetAlign("right"));
        ...
        SmartDashboard.putData("ElevatorToPosition33", new ElevatorToPosition(33));
        SmartDashboard.putData("ElevatorToPosition10", new ElevatorToPosition(10));
       ...
       // SmartDashboard.putData("ElevatorToPosition", new ElevatorToPosition());
        ...
        SmartDashboard.putData("PistonPrep", new PistonPrep());
