...
public class OI {
    ...
    public JoystickButton retractPressureButton;
    ...
    public OI() {
        ...
        retractPressureButton = new JoystickButton(leftJoystick, 3);
        retractPressureButton.whenPressed(new RetractPressure());
        // pistonUpButton = new JoystickButton(leftJoystick, 1);
        // pistonUpButton.whileHeld(new ClimbDoNothing());
