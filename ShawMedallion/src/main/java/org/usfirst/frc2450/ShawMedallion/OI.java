...
public class OI {
    ...
    public OI() {
        ...
        turn180Button = new JoystickButton(rightJoystick, 5);
        turn180Button.whenPressed(new TURN180());

        leftJoystick = new Joystick(0);
        
        pistonDownButton = new JoystickButton(leftJoystick, 2);
        pistonDownButton.whenPressed(new PistonDown());
        pistonUpButton = new JoystickButton(leftJoystick, 1);
        pistonUpButton.whenPressed(new PistonUp());
