...
public class OI {
    ...
    public JoystickButton targetAimButton;
    ...
    public OI() {
        ...
        targetAimButton = new JoystickButton(rightJoystick, 2);
        targetAimButton.whileHeld(new TargetSeek());
        ...
        SmartDashboard.putData("TurnWithAngle", new TurnWithAngle(-20));
        SmartDashboard.putData("TargetSeek", new TargetSeek());
        SmartDashboard.putData("TURN180", new TURN180());
        SmartDashboard.putData("TargetStrafeRight", new TargetStrafeRight());
        SmartDashboard.putData("TargetStrafeLeft", new TargetStrafeLeft());
