...
public class OI {
    ...
    public JoystickButton MaintainAlignLeft;
    public JoystickButton MaintainAlignRight;
    ...
    public OI() {
        ...
        elevatorUpButton = new JoystickButton(rightJoystick, 7);
        elevatorUpButton.whenPressed(new EleUP());
        elevatorDropButton = new JoystickButton(rightJoystick, 8);
        elevatorDropButton.whenPressed(new ElevatorDrop());
        MaintainAlignLeft = new JoystickButton(rightJoystick, 3);
        MaintainAlignLeft.whileHeld(new MaintainAlignLeft());
        MaintainAlignRight = new JoystickButton(rightJoystick, 4);
        MaintainAlignRight.whileHeld(new MaintainAlignRight());
